...
class ValidationRule:
    ...
    def __init__(self, message: str, suggestion: Optional[str] = None, code: Optional[str] = None):
        """
    ...
    def validate(self, field_path: str, value: Any, context: Dict[str, Any]) -> Optional[ValidationIssue]:
        """
        Validate a value.
...
class TypeRule(ValidationRule):
    ...
    def __init__(self, expected_type: Type, message: Optional[str] = None, **kwargs):
        """
...
class PathRule(ValidationRule):
    ...
    def __init__(self, must_exist: bool = False, must_be_file: bool = False, 
                 must_be_dir: bool = False, is_readable: bool = False, 
                 is_writable: bool = False, **kwargs):
        """
...
class CustomRule(ValidationRule):
    ...
    def __init__(self, validator: Callable[[Any, Dict[str, Any]], Optional[str]], **kwargs):
        """
