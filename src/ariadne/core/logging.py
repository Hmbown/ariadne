...
class AriadneLogger:
    ...
    def set_circuit_context(self, circuit: QuantumCircuit, circuit_id: Optional[str] = None):
    ...
    def log_routing_decision(self, circuit: QuantumCircuit, backend: str, 
                           confidence: float, reason: str, **kwargs):
