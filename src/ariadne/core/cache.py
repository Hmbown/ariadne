...
class CircuitAnalysisCache:
    ...
    def get_analysis(self, circuit: QuantumCircuit) -> Optional[Dict[str, Any]]:
        """
    ...
    def get_entry_info(self, circuit: QuantumCircuit) -> Optional[Dict[str, Any]]:
        """
...
_global_cache: Optional[CircuitAnalysisCache] = None
