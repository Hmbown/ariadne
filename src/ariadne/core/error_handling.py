...
class BackendUnavailableError(AriadneError):
    ...
    def __init__(self, backend_name: str, reason: str, details: Optional[dict[str, Any]] = None):
...
class CircuitTooLargeError(AriadneError):
    ...
    def __init__(self, num_qubits: int, depth: int, backend: Optional[str] = None):
...
class SimulationError(AriadneError):
    ...
    def __init__(self, message: str, circuit_info: Optional[dict[str, Any]] = None, 
