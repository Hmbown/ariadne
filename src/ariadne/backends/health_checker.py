...
class BackendHealthChecker:
    ...
    def get_backend_metrics(self, backend: BackendType) -> Optional[BackendHealthMetrics]:
        """
    ...
    def get_healthy_backends(self) -> List[BackendType]:
        ...
        """
        return [
            backend for backend, status in self._backend_status.items()
...
_global_health_checker: Optional[BackendHealthChecker] = None
