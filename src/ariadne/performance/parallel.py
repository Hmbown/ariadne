...
class ParallelSimulator:
    ...
    def simulate_batch(
        self,
        requests: List[ParallelSimulationRequest]
    ...
    def _simulate_batch_single_thread(self, requests: List[ParallelSimulationRequest]) -> List[ParallelSimulationResult]:
...
_global_parallel_simulator: Optional[ParallelSimulator] = None
